...
-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('SINGLE', 'TRUEFALSE', 'FILL_BLANK');

-- CreateEnum
CREATE TYPE "QuizFormat" AS ENUM ('TEXT_CHOICE', 'IMAGE_CHOICE');

-- CreateEnum
CREATE TYPE "DuelStatus" AS ENUM ('WAITING', 'IN_PROGRESS', 'FINISHED');
...
CREATE TABLE "Quiz" (
    ...
    "format" "QuizFormat" NOT NULL DEFAULT 'TEXT_CHOICE',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "Rating" (
    ...
    CONSTRAINT "Rating_pkey" PRIMARY KEY ("userId","quizId")
);
...
-- CreateIndex
CREATE INDEX "Rating_quizId_idx" ON "Rating"("quizId");
...
-- CreateIndex
CREATE INDEX "DuelParticipant_duelId_idx" ON "DuelParticipant"("duelId");
...
-- AddForeignKey
ALTER TABLE "Duel" ADD CONSTRAINT "Duel_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DuelParticipant" ADD CONSTRAINT "DuelParticipant_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
