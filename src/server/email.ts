...
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL ?? 'noreply@quizarena.app'
...
export async function sendPasswordResetEmail(to: string, resetUrl: string): Promise<void> {
  ...
  try {
    await resend.emails.send({
      ...
      text: `Reset your QuizArena password by visiting:\n${resetUrl}\n\nThis link expires in 1 hour. If you did not request a password reset, you can ignore this email.`,
    })
  } catch (error) {
...
<body style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px">
  <h1 style="font-size:24px;margin-bottom:8px">Welcome to QuizArena!</h1>
  ...
  <p style="color:#888;font-size:12px;margin-top:24px">This link expires in 24 hours. If you did not create a QuizArena account, you can safely ignore this email.</p>
</body>
</html>`
}
...
<head><meta charset="utf-8" /></head>
<body style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px">
  <h1 style="font-size:24px;margin-bottom:8px">Reset your QuizArena password</h1>
