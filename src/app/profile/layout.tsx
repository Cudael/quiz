  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 py-8 md:py-12">
      <div className="flex flex-col gap-8">
        ...
        <section className="relative overflow-hidden rounded-md border border-border bg-card p-6 md:p-8">
          <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <div className="relative mx-auto sm:mx-0 shrink-0">
                ...
                />
                <div className="absolute -bottom-1 -right-1 flex h-6 w-16 items-center justify-center rounded-sm bg-quiz-purple px-1.5 py-0.5 text-[10px] font-extrabold tracking-wider text-white shadow ring-2 ring-card uppercase">
                  Lv. {progress.level}
                </div>
              </div>
              <div className="text-center sm:text-left">
                ...
                {user.streakDays > 0 && (
                  <div className="mt-2.5 inline-flex items-center gap-1.5 rounded-sm bg-quiz-orange/5 border border-quiz-orange/15 px-3 py-1 text-xs font-bold text-quiz-orange shadow-sm">
