...
export default function StatisticsPage() {
  ...
  const isCfConfigured = !!CF_BEACON_TOKEN
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <p>
                <strong>Script size:</strong> ~45KB
              </p>
            </div>
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold">Cloudflare Web Analytics</h3>
                <p className="text-xs text-muted-foreground">Privacy-first lightweight analytics</p>
              </div>
            </div>
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>
                <strong>Tracks:</strong> Page views, Core Web Vitals, traffic sources
              </p>
              <p>
                <strong>Privacy:</strong> No cookies, GDPR-compliant by default
              </p>
              <p>
                <strong>Script size:</strong> ~1KB
              </p>
            </div>
            ...
            {isCfConfigured ? (
              ...
              <p className="text-xs text-muted-foreground">
                Enable in Cloudflare Dashboard → Analytics → Web Analytics, then add{' '}
                <code className="rounded bg-muted px-1">NEXT_PUBLIC_CF_BEACON_TOKEN</code> to{' '}
        ...
        <CardContent className="pt-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 text-sm">
            ...
            <div>
              ...
              <p className="text-muted-foreground">LCP, FID, CLS — via Cloudflare Analytics.</p>
            </div>
            <div>
