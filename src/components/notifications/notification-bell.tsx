    ...
    >
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          {unreadCount > 0 ? (
            <span className="absolute -right-1.5 -top-1.5 inline-flex min-w-5 items-center justify-center rounded-sm bg-red-500 px-1 text-[10px] font-semibold text-white">
